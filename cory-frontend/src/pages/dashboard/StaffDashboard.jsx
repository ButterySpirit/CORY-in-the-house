...
export default function StaffDashboard() {
  ...
  if (!user || user.role !== "staff") return <p className="text-center mt-10 text-red-500">Access denied</p>;
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-8">
      ...
      <section>
        <h2 className="text-xl font-semibold mb-3">My Job Applications</h2>
